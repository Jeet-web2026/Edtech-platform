<div>
    <div class="shadow-sm rounded overflow-hidden bg-white">
        ...
        <div class="p-3">
            ...
            <div class="flex lg:flex-row flex-col items-center justify-center gap-3 mt-3 border-t border-gray-200 pt-3">
                <a href="" class="bg-[#603CF6] text-white w-full py-2 text-center rounded border border-white hover:bg-white hover:text-[#603CF6] transition-all duration-300 hover:border hover:border-[#603CF6]">
                    View details
                </a>
                <a href="" class="bg-[#603CF6] text-white w-full py-2 text-center rounded border border-white hover:bg-white hover:text-[#603CF6] transition-all duration-300 hover:border hover:border-[#603CF6]">
                    Book now
