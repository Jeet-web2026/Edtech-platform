        ...
        <nav role="navigation" class="py-4">
            <div class="flex flex-col lg:flex-row items-center justify-between container mx-auto">
                ...
                <div role="navigation" class="flex lg:flex-row flex-col items-center gap-2.5">
                    ...
                    <div class="flex items-center gap-1 flex-row cursor-pointer">
                        <span class="text-base text-white font-medium">About us</span>
                        <i class="ri-arrow-down-s-line text-lg font-medium text-white"></i>
                    </div>
                    <div class="flex items-center gap-1 flex-row cursor-pointer">
                        <span class="text-base text-white font-medium">Forum</span>
                        <i class="ri-arrow-down-s-line text-lg font-medium text-white"></i>
                    </div>
                    <a href="{{ route('blogs') }}" wire:navigate>
                        <span class="text-base text-white font-medium">Blogs</span>
                    </a>
                    <a href="{{ route('contact') }}" wire:navigate>
                        <span class="text-base text-white font-medium">Contact</span>
                    </a>
                    <button type="button" class="ms-2">
                        <i class="ri-search-2-line text-white font-medium"></i>
                    </button>
                    <a href="" class="mx-2">
