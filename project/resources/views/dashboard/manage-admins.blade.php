        ...
        <table class="w-full text-sm text-left rtl:text-right bg-blue-300 border border-gray-200">
            ...
            <tbody>
                ...
                <tr class="bg-white dark:border-gray-700 border-gray-200 hover:bg-gray-100 duration-300 transition dark:hover:bg-gray-100">
                    <th scope="row" class="px-6 py-3 text-sm font-medium text-black whitespace-nowrap border-r border-gray-400">
                        {{ $admin->first_name . ' ' . $admin->last_name }}
                    </th>
                    <td class="px-6 py-2 border-r border-gray-400 text-sm font-medium text-center">
                        <label class="inline-flex items-center cursor-pointer">
                            <input type="checkbox" {{ $admin->is_active ? 'checked' : '1' ?? '' }} value="1" class="sr-only peer">
                    ...
                    <td class="px-6 py-2 border-r border-gray-400 text-center text-sm font-medium">
                        {{ $admin->email }}
                    </td>
                    <td class="px-6 py-2 text-sm border-r border-gray-400 font-medium">
                        x
                    </td>
